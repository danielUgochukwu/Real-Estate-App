...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const isusername = formData.emailOrUsername.includes(' ');
      const signInData = isEmail || isusername
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <input type="text" placeholder="Email or Username" className="border p-3 rounded-lg" id="emailOrUsername" onChange={handleChange} />
